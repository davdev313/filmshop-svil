...
function Footer() {
    return (
        <footer className="footer py-3 mt-auto bg-first-color">
            <div className="container d-flex flex-wrap justify-content-between align-items-center">
                ...
                <ul className="nav col-md-4 justify-content-end list-unstyled d-flex align-items-center flex-column">
                    ...
                    <div className="d-flex flex-row">
                        <li className="ms-3"><a className="text-muted" title="React JS" href="https://it.reactjs.org/">
